...
CREATE TABLE IF NOT EXISTS student_guardians (
  ...
  KEY idx_student_guardians_parent_status_student (parent_user_id, status, student_id),
  ...
  CONSTRAINT fk_student_guardians_revoker FOREIGN KEY (revoked_by_user_id) REFERENCES users(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
