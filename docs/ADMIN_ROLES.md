...
12. Parents choose one active school during registration and may submit up to ten student references. With no reference, that school must already have a pending assignment for the registered email. New accounts remain `pending` without a session or guardian link. Only that school's administrator can approve after at least one same-school reference or recorded-email match, reject, or reopen a rejected request. Approval links all matching references and recorded assignments; unmatched references remain saved. This review is school-wide and does not depend on the selected school year. Registrars see the approved contact directory but cannot review requests.
