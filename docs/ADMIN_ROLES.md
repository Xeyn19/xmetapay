...
Parents can organize their own Fee summary by archiving paid or zero-balance assignments. From Archived fees, they can restore rows or permanently remove them from their own Fee summary. Permanent removal sets a parent-specific tombstone and cannot be undone in the parent portal; it does not delete the school assignment, hide an outstanding balance, affect another linked guardian, or alter balances, terms, payments, receipts, metrics, exports, admin reports, and payment history.

Parents can also organize Payment history through parent-specific Current and Archived views. Paid, failed, voided, and refunded payment rows can be archived or restored; pending payments stay visible until processing finishes. From Archived payments, a parent can permanently remove individual or selected rows from their Payment history and exports. This irreversible parent-facing tombstone never changes receipts, allocations, balances, wallet top-ups, dashboard activity, admin collections, reports, or audit records.
