...
import { ClipboardList, Plus, Receipt, X } from "lucide-react";

import { cn } from "@/lib/utils";

export function OtherFeeActionModal({
  title,
  description,
  triggerLabel,
  triggerIcon,
  ...
  const titleId = useId();
  const TriggerIcon = triggerIcon === "receipt" ? Receipt : Plus;
