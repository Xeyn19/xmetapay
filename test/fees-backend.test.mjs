...
test("admin tuition and other-fees pages expose database-backed fee forms", () => {
  ...
  assert.match(tuitionTable, /admin-tuition-report\.xlsx/);
  assert.match(tuitionTable, /worksheetName: "Tuition report"/);
  assert.match(tuitionTable, /exportRowsToExcel/);
  assert.match(tuitionTable, /schoolName/);
  assert.match(tuitionTable, /schoolYearName/);
  assert.match(tuitionTable, /Total billed/);
  assert.doesNotMatch(tuitionTable, /admin-tuition-report\.csv|exportRowsToCsv/);
  ...
  assert.match(otherFeesPage, /getAdminSchoolContext\(session\.userId\)/);
  ...
  assert.match(otherFeesTable, /admin-other-fees\.xlsx/);
  assert.match(otherFeesTable, /worksheetName: "Other fees"/);
  assert.match(otherFeesTable, /exportRowsToExcel/);
  assert.match(otherFeesTable, /schoolName/);
  assert.match(otherFeesTable, /schoolYearName/);
  assert.match(otherFeesTable, /Assigned total/);
  assert.match(otherFeesTable, /Outstanding/);
  assert.doesNotMatch(otherFeesTable, /admin-other-fees\.csv|exportRowsToCsv/);
